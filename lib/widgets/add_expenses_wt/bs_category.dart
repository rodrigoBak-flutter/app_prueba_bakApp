import 'package:klikticket/widgets/add_expenses_wt/admin_category.dart';
import 'package:klikticket/widgets/add_expenses_wt/create_category.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

import 'package:klikticket/models/features_model.dart';
...
import 'package:klikticket/widgets/add_expenses_wt/category_list.dart';
...
class _BSCategoryState extends State<BSCategory> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.cModel.category != 'Tipo de Gasto'){
      hasData = true;
    }
